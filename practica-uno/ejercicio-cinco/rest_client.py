...
if __name__ == "__main__":
    nuevo_animal = crear_animal("León", "Felino", "Masculino", 5, 150)
    print( nuevo_animal)
    animales = listar_animales()
    print( animales)

    felinos = buscar_animales_por_especie("Felino")
    print(felinos)
    genero = buscar_animales_por_genero("hembra")
    print(genero)

    animal_actualizado = actualizar_animal(1, "Leona", "Felino", "Femenino", 6, 160)
